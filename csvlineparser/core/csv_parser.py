...
from csvlineparser.core.csv_consumer_interface import ICsvConsumer
from csvlineparser.core.exceptions import CsvParserTooMuchDataException, CsvParserNoTermQuoteException
from csvlineparser.core.multi_consumer import MultiConsumer
...
class CsvParser:
    ...
    def __init__(self, debug_offset: int = 20, new_line_replacer: str = ' * ') -> None:
        super().__init__()
        self.__first_row: bool = True
        self.__current_row: str = ''
        self.__debug_offset: int = debug_offset
        self.__line_number: int = 0
        self.__new_line_replacer: str = new_line_replacer
